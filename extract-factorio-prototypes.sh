...
(
  ...
  python -m factorio_prototypes_schema.extract $FACTORIO_LOCATION >src/factorio_prototypes_schema.pure.json
  python -m factorio_prototypes_schema.patch <src/factorio_prototypes_schema.pure.json >src/factorio_prototypes_schema.tmp.json
)
npx prettier --write src/factorio_prototypes_schema.*.json
